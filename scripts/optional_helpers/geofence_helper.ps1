...
# Note: Uncomment lines that will be used by you, to uncomment, you remove the # symbol from before it.
# Note2: It can work in any game as long as you know the correct .exe location and the ips / ip ranges you want to block. In a multiplayer game, you can usually find the IPs in the support / wiki section.
